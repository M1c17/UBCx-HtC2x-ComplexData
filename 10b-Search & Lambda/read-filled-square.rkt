...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname read-filled-square) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; =================
;; Data definitions:
...
;; read-square is a way of seeing whats already in the board
...
;; fill-square is the way of writing a number into a board.
